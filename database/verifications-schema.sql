...
-- INSERT INTO verifications (user_id, verification_type, verification_status, reference_code, verification_data) VALUES
-- (1, 'email', 'verified', 'REF-2024-001', '{"email": "user@example.com", "verified_at": "2024-01-15 10:30:00"}'),
-- (1, 'phone', 'pending', 'REF-2024-002', '{"phone": "+2348012345678"}'),
-- (2, 'bvn', 'verified', 'REF-2024-003', '{"bvn": "12345678901", "verified_at": "2024-01-16 14:20:00"}');

-- Grant necessary permissions (adjust as needed)
-- GRANT SELECT, INSERT, UPDATE, DELETE ON lil_done.verifications TO 'your_app_user'@'localhost';
-- GRANT SELECT, INSERT ON lil_done.verification_logs TO 'your_app_user'@'localhost';
