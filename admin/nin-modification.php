<?php
// admin/nin-modification.php
require_once '../config/config.php';
require_once '../config/database.php';

$currentPage = 'nin-modification.php';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>NIN Modification - Admin Panel</title>
...
<body>
        ...
        <div class="row">
            ...
            <div class="main-content">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h2><i class="fas fa-id-card me-2"></i>NIN Modification Requests</h2>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hover" id="modTable" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>ID</th>
                                        <th>Date</th>
    ...
    <script>
                    ...
                    { 
                        ...
                        render: data => {
                            try {
                                ...
                                return json.modification_type || 'N/A';
                            } catch(e) { return 'N/A'; }
                        }
                    },
                    { 
        ...
        function refreshTable() { modTable.ajax.reload(); }
